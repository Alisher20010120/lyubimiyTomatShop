...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const orders = [
        ...
        {
            id: 4,
            customer: "Sardor Umarov",
            date: "2023-04-19T14:20:00",
            status: "completed",
            total: 43000,
            products: [
                { id: 1, name: "Tomat pastasi", quantity: 1, price: 25000 },
                { id: 4, name: "Tomat sharbati", quantity: 1, price: 12000 },
                { id: 8, name: "Tomat pyuresi", quantity: 1, price: 15000 }
            ],
        ...
        },
        {
            ...
            total: 60000,
            products: [
                { id: 3, name: "Quritilgan tomat", quantity: 2, price: 30000 }
            ],
    ...
    function renderOrders(ordersToRender) {
        ...
        if (ordersToRender.length === 0) {
            tbody.innerHTML = '<tr><td colspan="6" class="text-center">Buyurtmalar topilmadi</td></tr>';
            return;
        }
